<nav x-data="{ open: false }" class="fixed top-0 w-full z-50 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @can('author-manages')
                    <x-nav-link href="{{ route('author.posts.index') }}" :active="request()->routeIs('author.posts.index')">
                        {{ __('Your Articles') }}
                    </x-nav-link>
                    @endcan

                    @can('author-manages')
                    <x-nav-link href="{{ route('author.all-posts.index') }}" :active="request()->routeIs('author.all-posts.index')">
                        {{ __('Articles Stored') }}
                    </x-nav-link>
                    @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @can('author-manages')
            <x-responsive-nav-link href="{{ route('author.posts.index') }}" :active="request()->routeIs('author.posts.index')">
                {{ __('Your Articles') }}
            </x-responsive-nav-link>
            @endcan

            @can('author-manages')
            <x-responsive-nav-link href="{{ route('author.all-posts.index') }}" :active="request()->routeIs('author.all-posts.index')">
                {{ __('Articles Stored') }}
            </x-responsive-nav-link>
            @endcan
