    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @if ($posts->isEmpty())
                    <div class="col-span-1 md:col-span-2 lg:col-span-3 text-center mt-52">
                        <p class="text-gray-500 dark:text-gray-400 text-2xl">No Favorite Article Found</p>
                        <p class="text-gray-500 dark:text-gray-400 text-lg">Try To Add One !</p>
                    </div>
                @else
